 ...
 */
public final class XCQLMethodParam_Fill
{
    /** 行级填充时的常理之一：填充行级对象 */
    ...
    private final static XCQLMethodParam $FILL_PARAM_ROW    = new XCQLMethodParam_Fill_Row();
    
    private final static XCQLMethodParam $FILL_PARAM_ROW_NO = new XCQLMethodParam_Fill_RowNo();
     ...
     * @return
     */
    public static XCQLMethodParam getInstance(int i_ParamType ,Method i_ObjGetter)
    {
        if ( i_ParamType == $FILL_ROW )
        {
            return $FILL_PARAM_ROW;
        ...
        else if ( i_ParamType == $FILL_ROW_GETTER )
        {
            if ( i_ObjGetter != null )
            {
                return new XCQLMethodParam_Fill_Row_Getter(i_ObjGetter);
            }
            else
            {
 ...
 */
class XCQLMethodParam_Fill_Row implements XCQLMethodParam
{
    ...
    public XCQLMethodParam_Fill_Row()
    {
        this.paramType = XCQLMethodParam_Fill.$FILL_ROW;
    }
 ...
 * @createDate  2012-11-08
 */
class XCQLMethodParam_Fill_RowNo implements XCQLMethodParam
{
    ...
    public XCQLMethodParam_Fill_RowNo()
    {
        this.paramType = XCQLMethodParam_Fill.$FILL_ROW_NO;
    }
 ...
 * @createDate  2012-11-08
 */
class XCQLMethodParam_Fill_Row_Getter implements XCQLMethodParam
{
    ...
    public XCQLMethodParam_Fill_Row_Getter(Method i_ObjGetter)
    {
        this.paramType = XCQLMethodParam_Fill.$FILL_ROW_GETTER;
