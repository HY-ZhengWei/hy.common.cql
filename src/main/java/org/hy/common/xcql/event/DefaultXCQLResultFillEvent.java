package org.hy.common.xcql.event;
...
import org.hy.common.xcql.XCQLResultFillEvent;
 ...
 * @version     v1.0
 */
public class DefaultXCQLResultFillEvent implements XCQLResultFillEvent
{
    ...
    public DefaultXCQLResultFillEvent(List<Method> i_RelationKeyMethods ,List<Method> i_RelationValueMethods)
    {
